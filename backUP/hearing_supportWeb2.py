...
logging.basicConfig(filename='C:\\Users\\mjoll\\Desktop\\Streamlit\\hearing_support\\log.txt', level=logging.INFO)
# logging.basicConfig(filename='C:\Users\mjoll\Desktop\Streamlit\hearing_support\log.txt', level=logging.INFO)  # ログレベルをINFOに設定します
